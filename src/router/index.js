...
import ImClient from '@/views/chat/ImClient'
import ImServer from '@/views/chat/imServer/imServer'
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: '/chat',
          component: ImServer
          // component: r => require.ensure([], () => r(require('@/views/chat/imServer/imServer')), 'chatview')
        }
      ]
    },
    {
